...
namespace TrackITManagementSystem.UI
{
    public partial class frmAdmin : Form
    {
        ...
        private void btnAdd_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //Adding the values from the UI to the Database
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtUserName.Text.ToUpper() != "ADMIN")
                {
                    ...
                    u.image_name = imageName;
                    u.security_level = txtSecurityLevelChange.Text;
                    //Create a Boolean variable to check whether the data is updated successfully ot not
            ...
            else
            {
                ...
                else
                {
                    DialogResult dialogResult =
                        MessageBox.Show($"Are you sure you want to delete user: {txtUserName.Text}", "DELETE:",
                            MessageBoxButtons.YesNo);
                    if (dialogResult == DialogResult.Yes)
                    {
                        //Get the UsersId from the Text Box to Delete the User
                        u.user_id = int.Parse(txtUserID.Text);
                        ...
                        //Boolean value to check whether the user deleted or not
        ...
        {
            //Expression to exit the count
            //Once the user enters the admin page the count will be 2
            //This is due to the admin page loading on login
