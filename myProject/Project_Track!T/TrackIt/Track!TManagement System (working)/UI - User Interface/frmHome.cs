...
namespace TrackITManagementSystem
{
    public partial class frmHome : Form
    {
        ...
        private requestersBLL r = new requestersBLL();
        private requesterDAL dal = new requesterDAL();
        //Global variable for Chart ToolTip
        readonly ToolTip _tooltip = new ToolTip();
        //Global variable for checking Security Level to access Admin Page
        ...
        private void frmHome_Activated(object sender, EventArgs e)
        {
            ...
            //Sort Home - My Tickets by Date Added
            dvgUsers.Sort(dvgUsers.Columns[8], ListSortDirection.Descending);

            //Insert new headers on DataViewGrid
            ...
            dvgUsers.Columns[4].HeaderText = "Phone Number";
            dvgUsers.Columns[5].HeaderText = "Location";
            dvgUsers.Columns[6].HeaderText = "Issue Category";
            dvgUsers.Columns[7].HeaderText = "Priority Level";
            dvgUsers.Columns[8].HeaderText = "Date Created";
            dvgUsers.Columns[9].HeaderText = "Cost";

            //Open DataTable with only logged in user tickets
            DataTable dt = dal.LoadUserNameTickets(r.ticket_creator_userId.ToString());
            dvgUsers.DataSource = dt;
        }
        #endregion
