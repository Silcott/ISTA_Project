...
namespace TrackITManagementSystem.UI
{
    public partial class frmRequesters : Form
    {
        ...
        #region VALIDATION Methods for Phone and Email - REGEX
        //Method to validate Phone Number is correct Format in Update Method
        ...
        //Method to validate Email Address is correct Format in Update Method
        ...
        private void frmRequesters_Load(object sender, EventArgs e)
        {
            ...
            //Collection of Autocomplete Strings
            ...
            //Assign Autocomplete values to textboxes
            ...
            //Display Tickets in DataGrid View
            DataTable dt = dal.Select();
            dvgUsers.DataSource = dt;

            //Rename the headers in teh DataGridView
            ...
            dvgUsers.Columns[4].HeaderText = "Last User to Update";
            ...
            dvgUsers.Columns[14].HeaderText = "Creator UserID";
        }
        #endregion
        #region BACK Button
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            //Load User Tickets in home screen
            DataTable dt = dal.LoadUserNameTickets(r.ticket_creator_userId.ToString());
            dvgUsers.DataSource = dt;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
                ...
                textIssueDescription.Text == "")
            {
                ...
                if (textIssueDescription.Text == "")
                    MessageBox.Show("Issue Description Required");
            }
            else
            {
                if (txtEmail.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            r.ticket_creator_name = usr.GetCreatorNameFromUser(loggedInUser); ;
                            r.ticket_creator_userId = frmLogin.loggedInUserID;
        ...
        #endregion
        #region AUTOCOMPLETE Textbox Strings
        //Add Auto Fill Fields to Text Boxes for Tickets
        //First Name TextBox
                ...
                else
                {
                    if (txtEmail.Text != "")
                    {
                        if (IsValidEmail(txtEmail.Text) == false)
                            MessageBox.Show(txtEmail.Text + "\nEmail Format is Incorrect. Try jsmith@example.com");
                        else
                        {
                            if (IsValidPhone(txtPhone.Text) == false)
                            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (txtTicketID.Text == "")
            {
                //Display Message if a ticket hasn't been selected to delete
                MessageBox.Show("No Ticket Has Been Selected");
            }
            else
            {
                DialogResult dialogResult =
                    MessageBox.Show($"Are you sure you want to delete ticket: {txtTicketID.Text}", "DELETE:",
        ...
        #endregion
        #region METHOD to move form on screen
        ...
        private void btnUploadFile_Click(object sender, EventArgs e)
        {
            ...
            if (open.ShowDialog() == DialogResult.OK)
            {
                ...
                if (open.CheckFileExists)
                {
                    ...
                    fileName = DateTime.Now.ToString("yyyy-dd-M--HH-mm-ss") + RandInt + ext;
                    ...
                    destionationPath = paths + "\\files\\" + fileName;
        ...
        {
            //Grab file path from textbox
            destionationPath = txtFileNamePath.Text;
            //If path is empty or shows "no-file.txt" than show message 
