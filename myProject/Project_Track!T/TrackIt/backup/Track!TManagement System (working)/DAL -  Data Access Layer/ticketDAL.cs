    ...
    class requesterDAL
    {
        ...
        public bool Insert(requestersBLL r)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ticket_creator_userId", r.ticket_creator_userId);
                //Open Database Connection
                conn.Open();
        ...
        public bool Update(requestersBLL r)
        {
            ...
            try
            {
                ...
                string sql =
                    ...
                    "ticket_creator_userId=@ticket_creator_userId "+
        ...
        public DataTable LoadUserNameTickets(string user_ID)
        {
            //Create SQL Connection for database cooncetion
            SqlConnection conn = new SqlConnection(myconnstring);
            //Create object of DataTable to hold the data from the database and return it
            ...
            {
                //SQL Query to count tickets foir specific issue category
                string sql = "SELECT ticket_id, first_name, last_name, email, phone, location, issue_category, priority_level, added_date, cost FROM tbl_requesters WHERE ticket_creator_userId = '"+ user_ID + "'";
                //SQL Command to Execute
                SqlCommand cmd = new SqlCommand(sql, conn);
                //Sql Data Adapter to get teh  data from database
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
